      ...
      <motion.div className="flex flex-col items-center justify-center min-h-screen"
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <motion.p className="mt-10 text-center text-sm text-gray-500" variants={textMotion}>
            Not a member?{' '}
            <Link to="/luna-demo/sign-up/" className="font-semibold leading-6 text-indigo-600 hover:text-transparent bg-clip-text bg-gradient-to-l from-blue-500 to-purple-500">
              Join today for free.
            </Link>
          </motion.p>
